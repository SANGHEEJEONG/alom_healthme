...
class mypage_body_information : Fragment() {
  private lateinit var binding:FragmentMypageBodyInformationBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding=FragmentMypageBodyInformationBinding.inflate(layoutInflater)
...
//        name_edittext.keyListener = null
    ...
    private var _binding: FragmentMypageBodyInformationBinding? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment

        _binding = FragmentMypageBodyInformationBinding.inflate(inflater,container,false)
        return binding.root
